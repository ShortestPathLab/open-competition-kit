// Vendored from ui-service `*/components/ui/select.tsx`. Identical apart from
// import paths and the `container` on `SelectPrimitive.Portal`, which the host
// copy does not need: see `./portal`.
