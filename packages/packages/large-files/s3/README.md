...
| Config | Environment |
|---|---|
| `largeFiles.bucket` | `S3_BUCKET` |
| `largeFiles.accessKeyId` | `S3_ACCESS_KEY_ID` |
| `largeFiles.secretAccessKey` | `S3_SECRET_ACCESS_KEY` |
| `largeFiles.sessionToken` | `S3_SESSION_TOKEN` |
| `largeFiles.region` | `S3_REGION` |
| `largeFiles.endpoint` | `S3_ENDPOINT` |
